...
class Jamaadvisorypage extends Component {
  componentDidMount() {
    new WOW.WOW().init();
    window.scrollTo(0, 0);
  }
          ...
          <div class="container jama-advisory-toprow w-percent-90">
            <div class="row valign-wrapper">
              ...
              <div class="col s12 m12 pull-m6">
                <div
                  class="jamaadvisory-left-content wow fadeInUp"
                  data-wow-delay="0.4s"
                >
                  <h4>
                    <b>J</b>ama <b>A</b>dvisory & <b>R</b>esearch on <b>S</b>
                    tocks <b>(JARS)</b>{" "}
                  </h4>
                  <p>
            ...
            <div class="col s12 m8 l6 offset-m2 offset-l3 key-statics-section">
              <div class="Key-strength-title">
                ...
                <p>
                  ...
                  typesetting industry. Lorem of type and scrambled it to make a
        ...
        <div class="jars-section-portfolio">
          <div class="container w-percent-90">
            <div class="row valign-wrapper">
              ...
              <div class="col s12 m12 pull-m6">
                <div
                  class="Jars-section-left wow fadeInUp"
                  data-wow-delay="0.4s"
                >
                  <h4>How we performed over the years</h4>
                  <p class="no-padding">
                    Over the Financial years of 2010-2019, if you did investment{" "}
                    <br></br> of <span class="bold-text"> &#x20b9; 1crore</span>{" "}
                    Jamā returns would be as high as{" "}
                    <span class="bold-text"> &#x20b9; 13.29 crore.</span>{" "}
                  </p>
                  <p>
                    <span class="blue-text">JARS CAGR:</span> 29.53% p.a.
                  </p>
            ...
            <div class="row valign-wrapper">
              ...
              <div class="col s12 m6">
                ...
                >
                  ...
                  <p>
                    Lorem Ipsum is simply dummy text of the printing and
                    typesetting industry. Lorem of type and scrambled it to make
